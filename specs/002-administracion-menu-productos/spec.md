...
| Descripción | Obligatoria. Entre 20 y 1.000 caracteres, descartados los espacios de los extremos. Además, las tres condiciones de sustancia de FR-039 |
...
| Descripción | Obligatoria. Entre 30 y 500 caracteres, descartados los espacios de los extremos. Además, las tres condiciones de sustancia de FR-039 |
...
- **FR-039**: Toda descripción —de producto (FR-016) y de categoría (FR-003)— DEBE cumplir, además de su mínimo de caracteres, **tres condiciones de sustancia comprobables por el sistema**, y su incumplimiento DEBE rechazarse con un mensaje en español asociado al campo que explique **cuál de las tres falló**:
  ...
  1. **Al menos cinco palabras** de dos o más caracteres, contadas tras colapsar los espacios.
...
- **SC-025**: **El cliente sin voz llega a cualquier producto activo** usando solo los filtros por categoría y por tramo de precio. Se comprueba eligiendo tres productos al azar del catálogo de la semilla y alcanzando cada uno solo con filtros (Principio VI).
...
- **SC-032**: El **100 %** de las descripciones de la semilla menciona algo que su nombre no dice. Se comprueba leyéndolas una por una; es una revisión humana y así se declara, porque ningún sistema puede juzgarlo.
